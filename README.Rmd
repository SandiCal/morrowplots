...
Use morrowplots to load, explore, and analyze nearly 150 years of ag data from the historic Morrow Plots at the University of Illinois Urbana-Champaign. Articles provide mini lessons on the history of the plots and example code for exploration of the data.
